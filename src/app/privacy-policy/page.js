...
const page = () => {
  return (
    <>
      ...
      <div style={{ padding: "0 135px", marginTop: "70px" }}>
        <div data-custom-class="body">
              ...
              <strong>
                <span style={{ fontSize: 15 }}>
                  <span data-custom-class="subtitle">
                    Last updated{" "}
                    <bdt className="question">September 06, 2024</bdt>
                  </span>
                </span>
              </strong>
            </span>
                ...
                <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                  <span data-custom-class="body_text">
                    ...
                    <span style={{ color: "rgb(0, 58, 250)" }}>
                      <bdt className="question">
                        <a
                          href="http://www.beaconarabia.com"
                          target="_blank"
                          data-custom-class="link"
                        >
                          http://www.beaconarabia.com
                        </a>
                      </bdt>
                    </span>
                    <span style={{ fontSize: 15 }}>
          ...
          <div>
            ...
            <ul>
              <li data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
                <span style={{ fontSize: 15 }}>
                  ...
                  .{" "}
                  <bdt className="question">
                    A company which provides Business Consultancy, audit,
                    accounting, taxation, financial, technological services
                  </bdt>
                </span>
                <bdt className="statement-end-if-in-editor">
                  <span style={{ fontSize: 15 }} />
            ...
            <div style={{ lineHeight: "1.5" }}>
              ...
              <a
                data-custom-class="link"
                href="https://app.termly.io/notify/aa6c546f-72a5-469a-872c-c3f76c0b3160"
